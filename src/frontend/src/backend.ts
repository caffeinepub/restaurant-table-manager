...
export class Backend implements backendInterface {
    ...
    async createReservation(arg0: TableId, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string): Promise<ReservationId> {
        if (this.processError) {
            try {
    ...
    async deleteReservation(arg0: ReservationId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getReservationsByTable(arg0: TableId): Promise<Array<Reservation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReservationsByTable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTablesByRoom(arg0: RoomId): Promise<Array<Table>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTablesByRoom(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateReservation(arg0: ReservationId, arg1: TableId, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateReservation(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRoom(arg0: RoomId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
